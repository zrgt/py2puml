...
from pyaas2puml.asserts import assert_py2puml_is_file_content, assert_py2puml_is_stringio
...
def test_py2puml_model_on_py2uml_domain():
    """
    Ensures that the documentation of the pyaas2puml domain model is up-to-date
    """
    domain_diagram_file_path = CURRENT_DIR.parent.parent / 'pyaas2puml' / 'pyaas2puml.domain.puml'

    assert_py2puml_is_file_content('pyaas2puml/domain', 'pyaas2puml.domain', domain_diagram_file_path)
...
footer Generated by //pyaas2puml//
@enduml
"""
